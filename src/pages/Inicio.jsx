...
function Inicio() {
  return (
    <div className="bg-dark text-white text-center d-flex align-items-center justify-content-center" style={{ height: '80vh', backgroundImage: 'url(images/strawberries-2563395_1280.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
